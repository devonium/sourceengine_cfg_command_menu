...
do
	...
	l = l .. bindmenu_page .. 'alias bindmenu_next' ..	' bindmenu_page'.. page_ind .. '_next ' .. ';alias bindmenu_prev' ..' bindmenu_page'.. page_ind .. '_prev ' .. ';alias bindmenu_slot'..(ExtendedMenu and 8 or 6)..' echo "'..(ExtendedMenu and 8 or 6)..'.EXIT.[' .. page_ind .. '/' .. page_count .. ']"' .. ';bindmenu_printpage"\n' 
